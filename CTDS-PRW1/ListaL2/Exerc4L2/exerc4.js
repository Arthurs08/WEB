...
objBotao.addEventListener('click', function(){
    ...
    let mensagem, iniciaisIguais;

    let nome1 = objNome1.value;
    let nome2 = objNome2.value;

    //podemos recuperar qualquer caracter de uma string por meio do método abaixo, bastando passarmos a posição, na String, do caracter procurado
    ...
    //outra forma de compararmos Strings em JS, sem levar em consideração a conversão de minúsculas em maiúsculas, ou vice-e-versa é com o método abaixo. Ele retorna zero se as Strings forem iguais, independetemente da acentuação.
    iniciaisIguais = letraInicialNome1.localeCompare(letraInicialNome2);
